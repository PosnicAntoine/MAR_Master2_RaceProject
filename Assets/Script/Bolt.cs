...
public class Bolt : MonoBehaviour
{
    ...
    [SerializeField]
    float rayHeight = 2.0f;     //How high the bolt is off the "ground" (if the floor is not at 0, then this needs to be changed)
    ...
    [SerializeField]
    LineRenderer rayRenderer;       //Reference to a line renderer component
